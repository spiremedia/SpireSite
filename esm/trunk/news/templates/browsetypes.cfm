	...
	<cfif lcl.list.recordcount>
		<cfsavecontent variable="lcl.s.html">
			...
			<cfoutput query="lcl.list">
				<li><a <cfif lcl.id EQ id>class="selected"</cfif> href="../editNewsType/?id=#id#">#name#</a></li>
			</cfoutput>
			</ul>
			</div>
		</cfsavecontent>
		<cfset lcl.acc.add('NewsTypes',lcl.s.html)>
	<cfelse>
		<cfset lcl.acc.add("No News Types Loaded","")>
	</cfif>
</cfsilent>
