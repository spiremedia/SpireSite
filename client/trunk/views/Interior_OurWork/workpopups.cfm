...
<div id="corn" class="popupWeb">
	<img src="/ui/images/work_corn.jpg" />
            ...
            <div class="ww-social">
                <div class="soc-fb"><a href="http://facebook.com" rel="new-window" target="_blank"></a></div>
                <div class="soc-tw"><a href="http://twitter.com" rel="new-window" target="_blank"></a></div>
                <div class="soc-de"><a href="http://delicious.com/" rel="new-window" target="_blank"></a></div>
            </div><!---  end .ww_social --->
</div><!---- end .popupWeb --->
...
<div id="western" class="popupWeb">
	<img src="/ui/images/webpop_50cent.jpg" />
            <div class="ww_text">
                <div class="title-ww">Western Union <span class="sz12dm">eCommerce and Mobile Application</span></div>
                <div class="desc-ww">Spire has been working with Western Union for the past 10 years providing Strategy, Web Development, and User Experience Design services.  A notable on-going project is a Spire-developed, integrated eCommerce and Mobile solution in support of WU’s 10,000+ US-based agent locations.</div>
            </div><!---  end .ww_text --->
           <div class="ww-social">
				<div class="soc-fb"><a href="#shareOnFacebook#" class="socialpopup" target="_blank"></a></div>
				<div class="soc-tw"><a href="#shareOnTwitter#" target="_blank" id="twitter" class="socialpopup"></a></div>
...
<div id="sorin" class="popupWeb">
	<img src="/ui/images/work_sorin.jpg" />
            <div class="ww_text">
