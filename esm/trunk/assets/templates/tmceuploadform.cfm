		...
		var FileBrowserDialogue = {
			...
			imageChosen : function (id) {
				...
				if (typeof(win.ImageDialog) != "undefined") {
					...
					// insert information now
					win.document.getElementById(tinyMCEPopup.getWindowArg("input")).value = "{{asset[" + id + "]}}";
					win.document.getElementById("linktitle").value = document.getElementById("name").value;
				}
