...
<img style="font-size:11px;position:absolute;left:0;top:0;" src="/ui/images/no-bugs.gif" border="0"  align="absmiddle">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--- <cfdump var="#samples#" /> --->
  ...
  <hr size="1"  style="width:98%" />
   <a href="http://mxunit.org/license.txt" title="Copyleft - GNU 3.0 Public License"><img border="0" src="/ui/images/copyleft.png" align="absmiddle" title="Copyleft - GNU 3.0 Public License"> <cfoutput>#year(now())# MXUnit.org</cfoutput></a>
  </div>
</body>
</html>