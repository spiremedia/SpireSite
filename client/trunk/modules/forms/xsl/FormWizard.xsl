...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:param name="submitClass" select="'usrFrmSubmit'" />
			...
			<xsl:for-each select="li">
				<xsl:element name="p">
					<xsl:element name="label">
						...
						<xsl:choose>
							<xsl:when test="p/input[@type='checkbox' and @name='required']/@checked != ''">
								<span class="formreqd">* </span>
			...
			<xsl:element name="p">
				<xsl:element name="span">
					...
					<xsl:call-template name="input">
						...
						<xsl:with-param name="class" select="$submitClass" />
					</xsl:call-template>
				</xsl:element>
				<xsl:call-template name="input">
					<xsl:with-param name="id" />
    ...
    <xsl:template name="selectBox">
        ...
        <xsl:param name="class" select="'usrFrmSelect'" />
    ...
    <xsl:template name="inputGroup">
        ...
        <xsl:for-each select="$input">
            <xsl:call-template name="input">
                ...
                <xsl:with-param name="class" select="'usrFrmCheckRadio'" />
            </xsl:call-template>
			 <xsl:value-of select="' '"  />
            <xsl:element name="span">
                <xsl:value-of select="." />
