	...
	<tr>
		...
		<cfif (arrayLen(components) - 1) GT 0>
			<cfloop from="1" to="#arrayLen(components) - 1#" index="i">
				...
				<cfoutput><img src="/ui/images/blank.gif" height="16" width="#(20*i)#"><img class="inheritArrow" alt="Inheritance" title="Inheritance" src="/ui/images/inherit.jpg"></cfoutput>
			</cfloop>
...
<cfif len(trim(stComponent.attributes.hint))>
	<br>
	<img src="/ui/images/lightbulb.jpg" align="absmiddle" border="0"> #stComponent.attributes.hint#
</cfif>
	<p/>
	<hr />
</cfoutput>
...
<cfelse>
	...
	<tr class="">
		<td class="summaryTablePaddingCol" nowrap>&nbsp;</td><td nowrap class="summaryTablesigCol"><CODE>#thisMethod.access# <a href="#util.getDetailURL(thisMethod.returntype,stComponent.path)#" target="_self">#listLast(thisMethod.returnType, ".")#</a></CODE></td><td class="summaryTableSignatureCol">
			...
			<cfif len(trim(thisMethod.hint))>
			#thisMethod.hint#
			<cfif structKeyExists(thisMethod, "deprecated")><br /><strong><img src="/ui/images/exclamation.jpg" border="0" align="absmiddle" > Deprecated.</strong> <em>#thisMethod.deprecated#</em></cfif>
			</cfif>
			</div>
		</td>
	</tr>	
				...
				<cfloop from="1" to="#count#" index="i">
					<cfoutput><a href="#util.getDetailURL(thisComponent.package & '.' & thisComponent.name, '')####implementedMethodNames[i]#()">
						<cfif NOT methodNameSet.contains(implementedMethodNames[i])>
								<i>#implementedMethodNames[i]#</i></a> <img src="/ui/images/link_break.jpg" align="absmiddle" class="notImplemented" title="Warning: not found :: Allthough <strong>#implementedMethodNames[i]#</strong> belongs to an interface that is implemented in this CFC, the actual method itself cannot be found here." />
						<cfelse>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td>
					...
					<br>
					<img src="/ui/images/lightbulb.jpg" align="absmiddle" border="0"> #thisProperty.hint#
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td width="20px"></td>
							<td>
							<span class="codeTrigger"><img src="/ui/images/open.jpg" align="absmiddle"> Show code</span>
...
<p>
	<div class="detailBody">
		<cfif structKeyExists(thisMethod, "deprecated")>
			<span class="label"><img src="/ui/images/exclamation.jpg" border="0" align="absmiddle" > <strong>DEPRECATED</strong></span>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="20px"></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="summaryTableInheritanceCol"><img src="/ui/images/blank.gif" width="20px"></td>
				<td>
					<cfif thisMethod.hint NEQ "">
					<br>
					<div class="hintBox">
					<img src="/ui/images/lightbulb.jpg" align="absmiddle" border="0"> #thisMethod.hint#
					</div>
					<br>
					</cfif>
			...
			<cfif revealCode>
					<tr>
						<td class="summaryTableInheritanceCol"></td>
						<td><span class="codeTrigger"><img src="/ui/images/open.jpg" align="absmiddle"> Show code</span>
						<div id="#thismethod.name#" class="codeBlock">
