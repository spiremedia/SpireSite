<cfcomponent name="logobserver" extends="resources.systemlogs">
	...
	<cffunction name="init">
		...
		<cfset setLogInfo('{
			...
			"tableName":"forms",
			"events":{
				"insert form":{"message":"Inserted form item &quot;{name}&quot;."},
				"update form":{"message":"Updated form item &quot;{name}&quot;."},
				"delete form":{"message":"Deleted form item &quot;{name}&quot;."},
				"downloaded submissions":{"message":"Downloaded submissions for form &quot;{name}&quot;."}
			}
		}')>
