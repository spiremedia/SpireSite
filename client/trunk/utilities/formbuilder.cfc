<cfcomponent name="formBuilder" output="false">
	...
	<cffunction name="startForm" output="false">
		...
		<cfset add('<form action="#anchortext#" name="#arguments.formName#" id="#arguments.formname#" method="#arguments.addtlinfo.method#" class="userform">')>
	</cffunction>
	...
	<cffunction name="addDateField"  output="false">
		<cfset add('<p><label #showError(arguments.name)# for="#arguments.name#">#arguments.label#</label><input type="text" name="#arguments.name#" id="#arguments.name#" #arguments.style# value="#arguments.value#">(mm/dd/yyyy)</p>')>
	</cffunction>
