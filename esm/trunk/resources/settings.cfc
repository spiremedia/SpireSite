<cfcomponent name="settings">
	...
	<cffunction name="getinistring">
		<cfset var inistr = "">
		<cffile action="read" variable="inistr" file="#variables.settings.machineRoot & "resources/settings.cfm"#">
		<cfreturn inistr>
	</cffunction>
	
	<cffunction name="saveinistring">
		<cfargument name="str">
		<cffile action="write" output="#trim(str)#" file="#variables.settings.machineRoot & "resources/settings.cfm"#">
	</cffunction>
