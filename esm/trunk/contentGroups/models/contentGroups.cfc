	...
	<cffunction name="init">
		...
		<!--- <cfset setTableMetaData('{	
			...
			"fields":{
				...
				"description":{"type":"varchar","maxlen":500,"validation":"maxlength","label":"Description"},
				"htmlText":{"type":"varchar","maxlen":500,"validation":"maxlength","label":"Html Content"},
				"filename":{"type":"varchar","maxlen":100,"validation":"maxlength","label":"File"},
				"filesize":{"type":"varchar","maxlen":15,"validation":"maxlength","label":"FileSize"},
				"changedby":{"type":"varchar","maxlen":35},
				"deleted":{"type":"bit","default":0},
				"active":{"type":"bit","default":1},
				"itemdate":{"type":"date","validation":"notblank","label":"Item Date"},
