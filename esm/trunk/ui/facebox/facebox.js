...
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      opacity      : 0,
      overlay      : true,
      loadingImage : '/ui/facebox/loading.gif',
      closeImage   : '/ui/facebox/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="fb-body"> \
                ...
                <div class="fb-footer"> \
                  <a href="#" class="fb-close"> \
                    <img src="/ui/facebox/closelabel.gif" title="close" class="fb-close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
    ...
    loading: function() {
      ...
      $('#facebox .fb-body').children().hide().end().
    ...
    reveal: function(data, klass) {
      ...
      $('#facebox .fb-body').children().fadeIn('normal')
  ...
  function init(settings) {
    ...
    $('#facebox .fb-close_image').attr('src', $.facebox.settings.closeImage)
  }
