<cfcomponent
	...
	<cffunction
		...
		<cfif not fileexists(settings.getVar('machineroot') & "cache/observers/observers.cfm") OR isdefined("url.refresh")>
			<cfset createObject('component','resources.observersDiscovery').init(settings)>
		</cfif>
	...
	<cffunction name="onError">
		...
		<cfelse>
			...
			<p>Despite our best efforts, an unexpected error occurred. We have been notified of the issue and will be working to fix the problem.  Please try again soon. <br/>If you need to reach us, please call 303-233-3331.</p>
			<p><cfoutput>#CGI.REMOTE_ADDR#</cfoutput></p>
