	...
	<cffunction name="event">
		...
		<cfswitch expression="#arguments.eventname#">
            ...
            <cfcase value="delete member type">
            	<cfquery name="moreinfo" datasource="#variables.requestObject.getVar('dsn')#">
                	SELECT id, name FROM membertypes WHERE id = <cfqueryparam value="#moreinfo#" cfsqltype="cf_sql_varchar">
                </cfquery>
