...
<cfsavecontent variable="pageHead">
	<script type="text/javascript" src="/ui/js/spire-demo300.js"></script>
	
	<script type="text/javascript">
	//## iScroll 4 ##//
	var myScroll; var myScroll2;
	function loaded() {
		myScroll = new iScroll('wrapper', {
			snap: false, bounce: false,
			momentum: true, hideScrollbar: false,
			hScrollbar: false, scrollbarClass: 'myScrollbar', fadeScrollbar: true
		 }, 200);
					...
					<ul id="slider1">
					  ...
					  <li style="margin-right:2400px;">
						...
						<div id="main_le">
							<div id="wrapper">
								...
								<div id="navigator">
									<div class="btn-prev"><a href="##" class="active btn-wwa"></a></div>
									<div class="btn-main"><a href="##" class="active btn-wwa"></a></div>
									<div class="btn-next"><a href="##history" class="btn-history"></a></div>
								</div><!---  end ##navigator --->
					  ...
					  <li style="margin-right:2400px;">
						...
						<div id="crane"></div>
								...
								<div id="navigator">
									<div class="btn-prev"><a href="##leadership" class="btn-leadership"></a></div>
									<div class="btn-main"><a href="##" class="active btn-wwa"></a></div>
									<div class="btn-next"><a href="##careers" class="btn-careers"></a></div>
								</div><!--- end ##navigator --->
							</div><!--- end ##wrapper --->
...
If interested please send your resume and salary requirements to: kecnav at yahoo dot com</p>
										...
										<div class="srlink" id="submitResume">Submit Resume</div>
									</div>
...
<div class="pop-bgg bio_1">
	<div class="popup">
	    ...
	    <div class="pu-btns-linked-in-twitter">
	    	<div class="socialpub1"></div>
	        <div class="socialpub2"><a href="http://www.linkedin.com/in/mgellman" target="_blank"></a></div>
	        <div class="socialpub3"><a href="http://twitter.com/mgellman" target="_blank"></a></div>
	    </div>
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_1 --->
<div class="pop-bgg bio_2">
	<div class="popup">
	    ...
	    <div class="pu-btns-linked-in-twitter">
	    	<!--- <div class="socialpub1"></div> --->
	        <div class="socialpub2"><a href="http://www.linkedin.com/in/adamhasemeyer" target="_blank"></a></div>
	        <div class="socialpub3"><a href="https://twitter.com/Hasemeyer" target="_blank"></a></div>
	    </div>
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_2 --->
<div class="pop-bgg bio_3">
	<div class="popup">
	    ...
	    <div class="pu-btns-linked-in-twitter">
	    	<!--- <div class="socialpub1"></div> --->
	        <div class="socialpub2"><a href="http://www.linkedin.com/in/jimorsi" target="_blank"></a></div>
	        <div class="socialpub3"><a href="http://twitter.com/SpireUX" target="_blank"></a></div>
	    </div>
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_3 --->
<div class="pop-bgg bio_4">
	<div class="popup">
	    ...
	    <div class="pu-close"></div>
	   <div class="pu-btns-linked-in">
	    	<!--- <div class="socialpub1"></div> --->
	        <div class="socialpub2"><a href="http://www.linkedin.com/pub/kendra-smith/23/400/278" target="_blank"></a></div>
	        <!--- <div class="socialpub3"><a href="http://twitter.com/mgellman" target="_blank"></a></div> --->
	    </div>
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_4 --->
<div class="pop-bgg bio_5">
	<div class="popup">
	    ...
	    <div class="pu-btns-linked-in">
	    	<!--- <div class="socialpub1"></div> --->
	        <div class="socialpub2"><a href="http://www.linkedin.com/in/thaddeusbatt" target="_blank"></a></div>
	        <!--- <div class="socialpub3"><a href="http://twitter.com/mgellman" target="_blank"></a></div> --->
	    </div>	    
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_5 --->
<div class="pop-bgg bio_6">
	<div class="popup">
	    ...
	    <div class="pu-close"></div>
		<!---<div class="pu-btns">
	    	 <div class="pub1"><a href="mailto:email@spiremedia.com"></a></div>
	        <div class="pub2"><a href="http://linkedin.com"></a></div>
	        <div class="pub3"><a href="http://twitter.com"></a></div>
	    </div> --->
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_6 --->
<div class="pop-bgg bio_7">
	<div class="popup">
	    ...
	    <div class="pu-btns-linked-in">
	    	<!--- <div class="socialpub1"></div> --->
	        <div class="socialpub2"><a href="http://www.linkedin.com/in/treblered" target="_blank"></a></div>
	        <!--- <div class="socialpub3"><a href="http://twitter.com/mgellman" target="_blank"></a></div> --->
	    </div>
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_7 --->
<div class="pop-bgg bio_8">
	<div class="popup">
	    ...
	    <div class="pu-btns-linked-in">
	    	<!--- <div class="socialpub1"></div> --->
	        <div class="socialpub2"><a href="http://www.linkedin.com/in/gregglarson" target="_blank"></a></div>
	        <!--- <div class="socialpub3"><a href="http://twitter.com/mgellman" target="_blank"></a></div> --->
	    </div>
	    <div class="clearfloat"></div>
	</div>
</div><!--- >>>>>> end .pop-bgg bio_8 --->
