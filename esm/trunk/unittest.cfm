...
<cfparam name="url.testfile" default="*test">
...
<cfdirectory 
			action="list" 
				name="lcl.moduledirs" 
					directory="#request.requestObject.getVar("machineroot") & "/"#">
...
<cfloop query="lcl.moduledirs">
	<cfif type EQ "dir" 
		...
		<cfdirectory action="list" name="lcl.teststorun" directory="#dir#" filter="#url.testfile#.cfc">
