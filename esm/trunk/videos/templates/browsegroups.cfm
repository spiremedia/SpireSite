	...
	<cfif lcl.list.recordcount>
		<cfsavecontent variable="lcl.s.html">
			...
			<cfoutput query="lcl.list">
				<li><a <cfif lcl.id EQ id>class="selected"</cfif> href="../editVideoGroup/?id=#id#">#name#</a></li>
			</cfoutput>
			</ul>
			</div>
		</cfsavecontent>
		<cfset lcl.acc.add('Video Groups',lcl.s.html)>
	<cfelse>
		<cfset lcl.acc.add("No Groups Loaded","")>
	</cfif>
</cfsilent>
