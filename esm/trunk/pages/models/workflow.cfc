<cfcomponent name="workflow" extends="resources.abstractModel">
	...
	<cffunction name="sendPublishedEmail">
		...
		<cfset user.load(sentby)>
		<cfset targetuserinfo = user.getValues()>
		
		<cfset email.setSender('#targetuserinfo.fname# #targetuserinfo.lname# <#targetuserinfo.username#>')>
		
		<cfset user.load(sentto)>
		<cfset recipientuserinfo = user.getValues()>
		...
		<p>The page titled #page.pagename# has been published by #userObj.getFullName()#.</p><p>See the page here : <a href='#userobj.getCurrentSiteUrl()##page.urlpath#'>#userobj.getCurrentSiteUrl()##page.urlpath#</a>.</p>")>
	...
	<cffunction name="startreviewemail">
		...
		<cfset user.load(startedby)>
		<cfset targetuserinfo = duplicate( user.getValues() )>
		<cfset email.setSender('#targetuserinfo.fname# #targetuserinfo.lname# <#targetuserinfo.username#>')>
		<cfset user.load(targetedto)>
		
		<cfset recipientuserinfo = duplicate( user.getValues() )>
		<cfset email.setRecipient('#recipientuserinfo.fname# #recipientuserinfo.lname# <#recipientuserinfo.username#>')>
