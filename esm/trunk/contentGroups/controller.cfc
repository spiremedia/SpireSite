<cfcomponent name="Content Groups" extends="resources.abstractController">
	...
	<cffunction name="SaveContentGroup">
		...
		<cfif (requestvars.id EQ 0 AND NOT userObj.isAllowed("ContentGroups", "Add Content Group"))
				OR (requestvars.id NEQ 0 AND NOT userObj.isAllowed("ContentGroups", "Edit Content Group"))>
