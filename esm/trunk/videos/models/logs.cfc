<cfcomponent name="logobserver" extends="resources.systemlogs">
	...
	<cffunction name="init">
		...
		<cfset setLogInfo('{
			...
			"tableName":"videos",
			"events":{
				"save videos":{"message":"{savemode} video &quot;{name}&quot;."},
				"delete videos":{"message":"Delete video &quot;{name}&quot;."},
				"save videogroups":{"message":"{savemode} video group &quot;{name}&quot;.","tablename":"videogroups"},
				"delete videogroups":{"message":"Delete video group &quot;{name}&quot;.","tablename":"videoGroups"},
				"upload videofilename":{"message":"Uploaded video &quot;{videofilename}&quot;."},
				"upload thmbfilename":{"message":"Uploaded image &quot;{thmbfilename}&quot;."}
			}
		}')>
