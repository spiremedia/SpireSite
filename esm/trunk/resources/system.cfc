<cfcomponent
	...
	<cffunction 
		...
		<cfif not fileexists(application.settings.getVar('machineroot') & "cache/observers.cfm") OR isdefined("url.refresh")>
			<cfset createObject('component','resources.observerDispatchDiscovery').init(application.settings)>
		</cfif>
	...
	<cffunction name="onError">
		...
		<cfsavecontent variable="errorContent"><cfoutput>
			...
			<cfcatch>could not dump session</cfcatch></cftry>
			<p>Request Info:<br>
