<cfcomponent name="logobserver" extends="resources.systemlogs">
	...
	<cffunction name="requestReview">
		...
		<cfset var sentto = createObject('component','users.models.users').init(variables.requestObject,variables.userObject)>
		...
		<cfset sentto.load(moreinfo.sentto)>
		
		<cfset insertLog(	userid = variables.userObject.getUserId(), 
							pageid = moreinfo.pageid,
							description = 'Sent page "/#page.urlpath#" for REVIEW to #sentto.getfname()# #sentto.getlname()#.')>
	</cffunction>
	...
	<cffunction name="requestRevise">
		...
		<cfset insertLog(	userid = variables.userObject.getUserId(), 
							pageid = moreinfo.pageid,
							description = 'Sent page "/#page.urlpath#" for REVISION to #sentto.getfname()# #sentto.getlname()#.')>
	</cffunction>
