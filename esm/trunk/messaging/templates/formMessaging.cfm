...
<cfset lcl.form.addformitem('id', '', true, 'hidden', lcl.Messaging.getid() )>
<cfset lcl.form.addformitem('subject', 'Subject', true, 'text', lcl.Messaging.getsubject() )>
<cfset lcl.form.addformitem('moduleowner', 'Module Owner', true, 'text', lcl.Messaging.getmoduleowner() )>
<cfset lcl.options = structnew()>
<cfset lcl.options.style = "width:500px;height:600px;">
<cfset lcl.form.addformitem('textcontent', 'Message', true, 'tiny-mce', lcl.Messaging.gettextcontent(), lcl.options)>
