	...
	<cfif lcl.browse.recordcount>
		...
		<cfsavecontent variable="lcl.s.html">
			...
			<cfoutput query="lcl.browse">
				<li><a <cfif lcl.id EQ lcl.browse.id[lcl.browse.currentrow]>class="selected" <cfset lcl.acc.setselected(lcl.count)></cfif> href="/taxonomies/editTaxonomy/?id=#id#">#name#</a></li>
			</cfoutput>
			</ul>
			</div>
		</cfsavecontent>
