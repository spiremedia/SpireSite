...
<cfset lcl.filename = lcl.asset.getFilename()>
<cfset lcl.extension = listlast(lcl.filename,".")>
<cfset lcl.id = lcl.asset.getId()>
<cfif NOT listfind("jpg,png",lcl.extension)>
	Not applicable. Only jpg and png type files are editable.
<cfelse>
