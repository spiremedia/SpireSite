<cfcomponent name="SimpleContent" extends="resources.abstractControllerWEditables">
	...
	<cffunction name="editClientModule">
		...
		<cfset model = createObject('component', 'simpleContent.models.editable').init(requestObject, userobj)>
