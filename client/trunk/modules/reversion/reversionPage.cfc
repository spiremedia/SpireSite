<cfcomponent name="news View" extends="resources.page">
	<cffunction name="postObjectLoad">
		...
		<cfelse>
			<cfset data.content = lcl.reversioninfo.data>
		</cfif>
		...
		<!--- load module --->
		<cfset addObjectByModulePath('onecontent', lcl.reversioninfo.module, lcl.reversioninfo.title, data)>
	</cffunction>
