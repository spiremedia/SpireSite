...
<!---<cfif lcl.info.id EQ "">--->
	<cfset lcl.config = structnew()>
	<cfset lcl.config.url = "/pages/urlPathMatch/">
	<cfset lcl.config.mustMatch = true>
	<cfset lcl.config.style = "width:400px;">
<!---
	<cfset lcl.config = structnew()>
...
--->	
	<cfset lcl.form.addformitem('parentid', 'Parent Path', true, 'sitepagechooser', lcl.info.parentid, lcl.config)>
