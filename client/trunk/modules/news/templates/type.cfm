							...
							<div class="coda-slider" id="coda-slider-1">
								...
								<!--- <div class="panel" id="newsContent">
									<div class="panel-wrapper">										
										<div class="ncLeft">
											<div class="newsBox">
												<div class="nb-date">03.09.12</div>
												<div class="nb-title">Top Web Development Firms</div>
												<div class="nb-desc">In its annual listing, The Denver Business Journal ranked Spire as one of Colorado's Top Web Development Firms.</div>
											</div>
										...
										<div class="ncRight">
											<div class="newsBox">
												<div class="nb-date">01.08.12</div>
												<div class="nb-title">Corepower Yoga</div>
												<div class="nb-desc"><img src="/ui/images/img_news2.jpg" /><br />CorePower Yoga has launched it's new Spire-built web portal. <a href="##">See it here</a></div>
											</div>
								...
								<div class="panel" id="newsContent">
									<div class="panel-wrapper">
										<div class="ncLeft">
											<div class="newsBox">
												<div class="nb-date">03.09.11</div>
												<div class="nb-title">Top Web Development Firms</div>
												<div class="nb-desc">In its annual listing, The Denver Business Journal ranked Spire as one of Colorado's Top Web Development Firms.</div>
											</div>
										...
										<div class="ncRight">
											<div class="newsBox">
												<div class="nb-date">01.08.11</div>
												<div class="nb-title">Corepower Yoga</div>
												<div class="nb-desc"><img src="/ui/images/img_news2.jpg" /><br />CorePower Yoga has launched it's new Spire-built web portal. <a href="##">See it here</a></div>
											</div>
								...
								<div class="panel" id="newsContent">
									<div class="panel-wrapper">
										<div class="ncLeft">
											<div class="newsBox">
												<div class="nb-date">03.09.10</div>
												<div class="nb-title">Top Web Development Firms</div>
												<div class="nb-desc">In its annual listing, The Denver Business Journal ranked Spire as one of Colorado's Top Web Development Firms.</div>
											</div>
										...
										<div class="ncRight">
											<div class="newsBox">
												<div class="nb-date">01.08.10</div>
												<div class="nb-title">Corepower Yoga</div>
												<div class="nb-desc"><img src="/ui/images/img_news2.jpg" /><br />CorePower Yoga has launched it's new Spire-built web portal. <a href="##">See it here</a></div>
											</div>
								...
								<div class="panel" id="newsContent">
									<div class="panel-wrapper">
										<div class="ncLeft">
											<div class="newsBox">
												<div class="nb-date">03.09.09</div>
												<div class="nb-title">Top Web Development Firms</div>
												<div class="nb-desc">In its annual listing, The Denver Business Journal ranked Spire as one of Colorado's Top Web Development Firms.</div>
											</div>
										...
										<div class="ncRight">
											<div class="newsBox">
												<div class="nb-date">01.08.09</div>
												<div class="nb-title">Corepower Yoga</div>
												<div class="nb-desc"><img src="/ui/images/img_news2.jpg" /><br />CorePower Yoga has launched it's new Spire-built web portal. <a href="##">See it here</a></div>
											</div>
								...
								<div class="panel" id="newsContent">
									<div class="panel-wrapper">
										<div class="ncLeft">
											<div class="newsBox">
												<div class="nb-date">03.09.08</div>
												<div class="nb-title">Top Web Development Firms</div>
												<div class="nb-desc">In its annual listing, The Denver Business Journal ranked Spire as one of Colorado's Top Web Development Firms.</div>
											</div>
										...
										<div class="ncRight">
											<div class="newsBox">
												<div class="nb-date">01.08.08</div>
												<div class="nb-title">Corepower Yoga</div>
												<div class="nb-desc"><img src="/ui/images/img_news2.jpg" /><br />CorePower Yoga has launched it's new Spire-built web portal. <a href="##">See it here</a></div>
											</div>
