						...
						<div class="middleItem">
							...
							<div class="content">
								<cfif contentObjectNotEmpty('middleItem_1_Content')>
									#showContentObject('middleItem_1_Content', 'HTMLContent,Assets,dhtmlPager,Events,Forms,News,ProductCatalog,Search,SiteMaps,TextContent,Videos,Forms,MultiSpot,AssetImages', 'editable')#
								</cfif>

								<cfif contentObjectNotEmpty('middleItem_2_Content')>
									#showContentObject('middleItem_2_Content', 'HTMLContent,Assets,dhtmlPager,Events,Forms,News,ProductCatalog,Search,SiteMaps,TextContent,Videos,Forms,MultiSpot,AssetImages', 'editable')#
								</cfif>

								<cfif contentObjectNotEmpty('middleItem_3_Content')>
									#showContentObject('middleItem_3_Content', 'HTMLContent,Assets,dhtmlPager,Events,Forms,News,ProductCatalog,Search,SiteMaps,TextContent,Videos,Forms,MultiSpot,AssetImages', 'editable')#
								</cfif>

								<cfif contentObjectNotEmpty('middleItem_4_Content')>
									#showContentObject('middleItem_4_Content', 'HTMLContent,Assets,dhtmlPager,Events,Forms,News,ProductCatalog,Search,SiteMaps,TextContent,Videos,Forms,MultiSpot,AssetImages', 'editable')#
								</cfif>

								<cfif contentObjectNotEmpty('middleItem_5_Content')>
									#showContentObject('middleItem_5_Content', 'HTMLContent,Assets,dhtmlPager,Events,Forms,News,ProductCatalog,Search,SiteMaps,TextContent,Videos,Forms,MultiSpot,AssetImages', 'editable')#				
								</cfif>

								<cfif contentObjectNotEmpty('middleItem_6_Content')>
									#showContentObject('middleItem_6_Content', 'HTMLContent,Assets,dhtmlPager,Events,Forms,News,ProductCatalog,Search,SiteMaps,TextContent,Videos,Forms,MultiSpot,AssetImages', 'editable')#
								</cfif>
							</div>
						</div>
					</div>
